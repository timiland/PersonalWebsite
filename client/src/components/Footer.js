...
const iconSize = "lg";
const iconBox= "w-14 h-14 flex content-center justify-center transition duration-500 ease-in-out text-white hover:bg-white hover:text-green-800 border-white border-2 rounded-full";
